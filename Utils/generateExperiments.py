...
from main import Defaults, teleport, simple, CFagent, graphTrain, CFagentv2
...
# genExperiments(f"causal2_online_var", n=1, hours=12, level=Levels.Causal2, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0)
# genExperiments(f"causal5_online_var", n=1, hours=12, level=Levels.Causal5, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0)
# genExperiments(f"causal6_online_var", n=1, hours=12, level=Levels.Causal6, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0)
# genExperiments(f"causal7_online_var", n=1, hours=12, level=Levels.Causal7, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0)
...
genExperiments(f"CFv2cau1", n=2, hours=10, level=Levels.Causal1, main=CFagentv2, CF_convert=6, Counterfacts=1)
genExperiments(f"CFv2cau2", n=2, hours=10, level=Levels.Causal2, main=CFagentv2, CF_convert=6, Counterfacts=1)
