...
from main import Defaults, Load_Cfagent, teleport, simple, CFagent, graphTrain, CFagentv2, GraphMode, option_critic_run
...
# genExperiments(f"Causal4_Conver3", n=3, hours=24, level=Levels.Causal4, main=CFagent, CF_convert=3, TopN=3)
# genExperiments(f"Causal4_Conver4", n=3, hours=24, level=Levels.Causal4, main=CFagent, CF_convert=4, TopN=3)
...
# genExperiments(f"Maze_Conver4_3counterfactsNOCRASH", n=3, hours=24, level=Levels.Maze, main=CFagent, CF_convert=4, TopN=5, Counterfacts = 3)
...
# genExperiments(f"Attempt2_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_SuperLevel1_option_critic", n=3, hours=72, level=Levels.SuperLevel, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_SuperLevel2_option_critic", n=3, hours=72, level=Levels.SuperLevel2, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Coconuts_option_critic", n=3, hours=72, level=Levels.Coconuts, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_Monsters_option_critic", n=3, hours=72, level=Levels.MonsterLevel, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt2_DoorsAndKey_option_critic", n=3, hours=72, level=Levels.Causal1, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_SuperLevel1_option_critic", n=3, hours=72, level=Levels.SuperLevel, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_SuperLevel2_option_critic", n=3, hours=72, level=Levels.SuperLevel2, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Coconuts_option_critic", n=3, hours=72, level=Levels.Coconuts, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_Monsters_option_critic", n=3, hours=72, level=Levels.MonsterLevel, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt3_DoorsAndKey_option_critic", n=3, hours=72, level=Levels.Causal1, main=option_critic_run, cpu=True, batch=25)
# genExperiments(f"Attempt4_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_SuperLevel1_option_critic", n=3, hours=72, level=Levels.SuperLevel, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_SuperLevel2_option_critic", n=3, hours=72, level=Levels.SuperLevel2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Coconuts_option_critic", n=3, hours=72, level=Levels.Coconuts, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_Monsters_option_critic", n=3, hours=72, level=Levels.MonsterLevel, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt4_DoorsAndKey_option_critic", n=3, hours=72, level=Levels.Causal1, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_SuperLevel1_option_critic", n=3, hours=72, level=Levels.SuperLevel, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_SuperLevel2_option_critic", n=3, hours=72, level=Levels.SuperLevel2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Coconuts_option_critic", n=3, hours=72, level=Levels.Coconuts, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_Monsters_option_critic", n=3, hours=72, level=Levels.MonsterLevel, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt5_DoorsAndKey_option_critic", n=3, hours=72, level=Levels.Causal1, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_SuperLevel1_option_critic", n=3, hours=72, level=Levels.SuperLevel, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_SuperLevel2_option_critic", n=3, hours=72, level=Levels.SuperLevel2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt6_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=32)
...
# genExperiments(f"Attempt8_Lights1_option_critic", n=3, hours=72, level=Levels.Causal3, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Lights2_option_critic", n=3, hours=72, level=Levels.Causal4, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Diamonds1_option_critic", n=3, hours=72, level=Levels.Causal2, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Diamonds2_option_critic", n=3, hours=72, level=Levels.Causal5, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Diamonds3_option_critic", n=3, hours=72, level=Levels.Causal6, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Diamonds4_option_critic", n=3, hours=72, level=Levels.Causal7, main=option_critic_run, cpu=True, batch=32)
# genExperiments(f"Attempt8_Maze_option_critic", n=3, hours=72, level=Levels.Maze, main=option_critic_run, cpu=True, batch=32)
...
genExperiments(f"Diamonds1_0.5_NN_cpu", n=3, hours=10, level=Levels.Causal2, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
genExperiments(f"Diamonds2_0.5_NN_cpu", n=3, hours=10, level=Levels.Causal5, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
genExperiments(f"Diamonds3_0.5_NN_cpu", n=3, hours=10, level=Levels.Causal6, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
genExperiments(f"Diamonds4_0.5_NN_cpu", n=3, hours=10, level=Levels.Causal7, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
genExperiments(f"Diamonds1_0.0_NN_cpu", n=3, hours=10, level=Levels.Causal2, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
genExperiments(f"Diamonds2_0.0_NN_cpu", n=3, hours=10, level=Levels.Causal5, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
genExperiments(f"Diamonds3_0.0_NN_cpu", n=3, hours=10, level=Levels.Causal6, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
genExperiments(f"Diamonds4_0.0_NN_cpu", n=3, hours=10, level=Levels.Causal7, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
