...
genExperiments(f"Maze_Conver4_3counterfactsNOCRASH", n=3, hours=0, level=Levels.Maze, main=CFagent, CF_convert=4, TopN=5, Counterfacts = 3)
genExperiments(f"Coconuts_Conver4_3counterfactsNOCRASH", n=3, hours=0, level=Levels.Coconuts, main=CFagent, CF_convert=4, TopN=5, Counterfacts = 3)
genExperiments(f"MonsterLevel_Conver4_3counterfactsNOCRASH", n=3, hours=0, level=Levels.MonsterLevel, main=CFagent, CF_convert=4, TopN=5, Counterfacts = 3)
genExperiments(f"Causal3_Conver4_3counterfactsNOCRASH", n=3, hours=0, level=Levels.Causal3, main=CFagent, CF_convert=4, TopN=5, Counterfacts = 3)
