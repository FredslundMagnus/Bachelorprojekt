...
genExperiments(f"coconuts_CF_conver5", n=1, hours=34, level=Levels.Coconuts, main=CFagent, CF_convert=5)
genExperiments(f"coconuts_CF_conver6", n=1, hours=34, level=Levels.Coconuts, main=CFagent, CF_convert=6)
genExperiments(f"coconuts_CF_conver7", n=1, hours=34, level=Levels.Coconuts, main=CFagent, CF_convert=7)
genExperiments(f"coconuts_CF_conver8", n=1, hours=34, level=Levels.Coconuts, main=CFagent, CF_convert=8)
genExperiments(f"coconuts_CF_conver9", n=1, hours=34, level=Levels.Coconuts, main=CFagent, CF_convert=9)
genExperiments(f"coconuts_teleport", n=1, hours=34, level=Levels.Coconuts, main=teleport)
