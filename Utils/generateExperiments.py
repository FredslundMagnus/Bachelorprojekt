...
# genExperiments(f"Diamonds1_0.5_NN_cpu_2", n=3, hours=10, level=Levels.Causal2, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
# genExperiments(f"Diamonds2_0.5_NN_cpu_2", n=3, hours=10, level=Levels.Causal5, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
# genExperiments(f"Diamonds3_0.5_NN_cpu_2", n=3, hours=10, level=Levels.Causal6, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
# genExperiments(f"Diamonds4_0.5_NN_cpu_2", n=3, hours=10, level=Levels.Causal7, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.5, use_model=True, cpu=True)
# genExperiments(f"Diamonds1_0.0_NN_cpu_2", n=3, hours=10, level=Levels.Causal2, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
# genExperiments(f"Diamonds2_0.0_NN_cpu_2", n=3, hours=10, level=Levels.Causal5, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
# genExperiments(f"Diamonds3_0.0_NN_cpu_2", n=3, hours=10, level=Levels.Causal6, main=graphTrain, K1=200000, K2=100000, softmax_cap=0.0, failed_actions_chance=0.0, use_model=True, cpu=True)
