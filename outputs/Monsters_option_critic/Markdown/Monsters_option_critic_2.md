...
Traceback (most recent call last):
  ...
  File "/zhome/ea/9/137501/Desktop/Bachelor/Bachelorprojekt/save.py", line 34, in path
    os.mkdir("/".join(path))
FileExistsError: [Errno 17] File exists: 'outputs/Monsters_option_critic/Game'


# Parameters

    Name :                      Monsters_option_critic-2
...
Subject: Job 9601886: <Monsters_option_critic_2> in cluster <dcc> Exited

Job <Monsters_option_critic_2> was submitted from host <gbarlogin1> by user <s183914> in cluster <dcc> at Thu Apr 29 21:41:24 2021
...
Resource usage summary:
    ...
    CPU time :                                   258894.23 sec.
    Max Memory :                                 779 MB
    Average Memory :                             758.59 MB
    Total Requested Memory :                     16384.00 MB
    Delta Memory :                               15605.00 MB
    Max Swap :                                   -
    Max Processes :                              4
    Max Threads :                                6
    Run time :                                   258964 sec.
